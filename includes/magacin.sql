...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2018 at 09:22 AM
...
(1, 1, 'Asov', 'kom', 0, 13, '1'),
(2, 1, 'Lopata', 'kom', 0, 11, '1'),
(3, 1, 'Cekic', 'kom', 0, 11, '1'),
(4, 1, 'Brusna ploca 115x6', 'kom', 0, 10, '1'),
(5, 1, 'Rezna ploca 115x1', 'kom', 0, 20, '1'),
(6, 1, 'Metla', 'kom', 0, 10, '1'),
(7, 1, 'Osnovna farba siva', 'kom', 0, 0, '1'),
(8, 1, 'Cetka', 'kom', 0, 10, '1'),
(9, 1, 'stit mali (silt za bravu)', 'kom', 0, 0, '1'),
(10, 1, 'skalper', 'kom', 0, 0, '1'),
(11, 1, 'kalijev sapun', 'kom', 0, 0, '1'),
(12, 1, 'Cetka', 'm', 0, 0, '1'),
(13, 1, 'Diaflex 450', 'kom', 0, 0, '1'),
(14, 1, 'ELGEF spojka d90 (el. fuz. spojka)', 'kom', 0, 10, '1'),
(15, 1, 'PVC jahac fi250/160', 'kom', 0, 0, '1'),
(16, 1, 'Saht poklopac D400 (40T)', 'kom', 0, 0, '1'),
(17, 1, '', '', 0, 0, '1');
...
(1, 1, '2018-04-23', '', 2, '1', ',6/1/0 ', 2, '2018-04-23 07:43:15', '1');
...
(3, 2, 'admin', '$2y$10$yxfor7iBPf53IL/AkQrn3.SR9A2re1QLC8xs2O9M0PzOdmkjnwO0.', 'admin@gmail.com', 'Yes', NULL, 'No', '1');
...
CREATE TABLE `radnici` (
  ...
  `odelo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cipele` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('0','1','2','3') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `radnici` (`id_radnika`, `id_korisnika`, `id_kartica`, `ime`, `telefon`, `radno_mesto`, `zaduzenje`, `odelo`, `cipele`, `status`) VALUES
(1, 1, 0, 'Petar Cvetic', '0648950039', 'Magacioner', ',1/1/180423,2/2/180423+180425', '54', '42', '1'),
(2, 1, 0, 'Dragan Sabic', '0648952005', 'Bravar', '', '56', '42', '1');
...
(1, 1, '2018-04-23', '12', 1, ',1/10/0 ,2/10/0 ,3/10/0 ,6/10/0 ', 2, '2018-04-23 07:41:18', '1'),
(2, 1, '2018-04-25', '22', 1, ',1/3/0 ,2/3/0 ,8/10/0 ,6/1/0 ,5/10/0 ', 2, '2018-04-25 15:41:48', '1'),
(3, 1, '2018-04-25', '11', 3, ',14/10/0 ', 2, '2018-04-25 15:42:15', '1'),
(4, 1, '2018-04-25', '33', 2, ',4/10/0 ,5/10/0 ,3/1/0 ', 2, '2018-04-25 15:42:47', '1'),
(5, 1, '2018-05-05', '12', 5, ',1/1/0 ', 2, '2018-05-05 08:00:02', '1');
...
--
ALTER TABLE `artikli`
  MODIFY `id_artikla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `dobavljaci`
--
ALTER TABLE `dobavljaci`
  MODIFY `id_dobavljaca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `izlaz`
  MODIFY `id_izlaza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `ulaz`
  MODIFY `id_ulaza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
